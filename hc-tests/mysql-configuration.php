...
/**
 * Check that we are running at least MySQL 5
 * 
...
class HealthCheck_MySQL_Version extends HealthCheckTest {
	function run_test() {
		...
		$message = sprintf( __( 'Your Webserver is running MySQL version %1$s. WordPress highly recommends MySQL 5 or higher, because <a href="%2$s">MySQL 4 is full of gotchas</a>. Please contact your host and have them upgrade MySQL accordingly.', 'health-check' ), $version, 'http://sql-info.de/mysql/gotchas.html' );
